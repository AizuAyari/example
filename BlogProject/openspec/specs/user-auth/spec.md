...
User registration, login/logout, and session-aware header display for the blog app (server-rendered, session-based authentication using Django's built-in `User` model).
